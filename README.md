...
EU citizens who died from influenza
...
https://ec.europa.eu/eurostat/web/products-eurostat-news/-/DDN-20200407-1

Data

Eurostat's database: Causes of death - standardised death rate by NUTS 2 region of residence

Variables

Causes of death - standardised death rate
...
https://ec.europa.eu/eurostat/documents/4187653/10321595/Deaths_by_influenza.jpg

Reference

For more information on health statistics, visit this link.
...
Eurostat's database:Classroom teachers and academic staff by education level, programme orientation, sex and age groups

Variables

Primary to upper secondary teachers
...
For more information on education and training, visit this link.
...
Data	Eurostat’s database: Number of adults by working status within households, number of children and age of youngest child
Variables	
adults by working status within households, number of children and age of youngest child
type of household
...
Link	Duration of working life on the decline in 2020 - Products Eurostat News - Eurostat (europa.eu)
Data	Eurostat’s database: duration of working life and GDP per capita.
Variables	
Working years
GDP per capita
Geo
Reference	
For more information on duration of working life, visit this link.

For more information on GDP, visit this link.
...
Data	Eurostat’s database: Self-employment by sex, age and economic activity
Variables	
Own account workers by economic activity
Reference	The figures were collected through the EU Labour Force Survey.
...
Data	Eurostat’s database: Projected old-age dependency ratio
Variables	
